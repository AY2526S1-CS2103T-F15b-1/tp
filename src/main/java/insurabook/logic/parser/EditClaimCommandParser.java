...
public class EditClaimCommandParser implements Parser<EditClaimCommand> {
    ...
    public EditClaimCommand parse(String args) throws ParseException {
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_CLAIM_AMOUNT, PREFIX_CLAIM_DATE, PREFIX_DESCRIPTION);
        ...
        try {
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditClaimCommand.MESSAGE_USAGE), e);
        }
