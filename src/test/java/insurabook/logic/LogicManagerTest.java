...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonInsuraBookStorage addressBookStorage =
                new JsonInsuraBookStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonInsuraBookStorage addressBookStorage = new JsonInsuraBookStorage(prefPath) {
            @Override
            public void saveInsuraBook(ReadOnlyInsuraBook addressBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
