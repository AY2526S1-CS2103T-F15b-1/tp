...
public class CommandTestUtil {
    ...
    public static final String VALID_BIRTHDAY_AMY = "2002-01-01";
    public static final String VALID_BIRTHDAY_BOB = "2003-04-01";
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY + "12Sept2024"; // not in YYYY-MM-dd format
