...
4.  GUI should look readable and aesthetically pleasing
5.  Should work without additional installations of libraries
6.  Should work locally on user's device
7.  GUI should adjust to device or have an adjustable window
